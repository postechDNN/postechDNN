...
* :bug: ':bug:' when you fixed bug.
* :rocket: ':rocket:' when you speed up the code via time complexity or code optimization.
...
### Code Style 
Check the [goolge c++ style guide](https://google.github.io/styleguide/cppguide.html).
