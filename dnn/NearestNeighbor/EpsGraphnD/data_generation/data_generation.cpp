...
// nonConvex polytope을 만들기 위해 점집합을 생성하는 함수 ------------------------------------------------------------------------------------------------------------------------
...
// halfplane 생성 함수들 (dim: dimension) ------------------------------------------------------------------------------------------------------------------------

// random하게 halfplane을 생성
...
// center(주관적 원점)을 지나는 halfplane 하나를 만들어내는 함수
...
// num_cuts: 나누는 cut의 개수. subpart의 개수는 따라서 num_cuts + 1이 됨.// x축 기준으로 
