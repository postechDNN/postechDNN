...
void autoTest(string dir, double epsilon, bool speedFlag, int useDataSetId) {
	...
	std::cout << "started autotest" << endl;
	...
	for (auto& i00 = iterDirDir; i00 != fs::end(iterDirDir); ++i00) {
		...
		std::cout << "before reading inputs" << endl;
		...
		std::cout << "finished reading inputs" << endl;
		...
		std::cout << "constructed epsGraph1" << endl;
		...
		if (!speedFlag) {
			...
			std::cout << "constructed epsGraph2" << endl;
		}
