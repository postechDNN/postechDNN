...
//site out �� �ڷ� ������ 45 ray�� ��� p_de / p_in�� �ƴ�,
//�ڱ��ڽ� line�� 2��и鿡 �ִ� ��� : �ڱ��ڽ� line�� site out �� ������ bisector == +1 ray (wavekind == pl)
//										site out �� ������ �������� �ڷ� ������ ������ bisector == -1 ray (wavekind == pl)
//�ڱ��ڽ� line�� 4��и鿡 �ִ� ��� :  �ڱ��ڽ� line�� site out �� ������ bisector == -1 ray (wavekind == pl)
//										site out �� ������ �������� �ڷ� ������ ������ bisector == +1 ray (wavekind == pl)
enum WaveKind {
	none_wave,
...
public:
	...
	void site_in_find_v1v2(Site * s, pair<float,float> &l_point, pair<float,float> &r_point) {
		...
		//vertex_vector.push_back(l_ptr);//site in point�� vertex vector�� �߰�??????????????????????
	...
	bool check_invalid_spike(Event &e) {
		//spike event ����� �� wave �� �ϳ��� wavefront bst�� ������ invalid ->return true
		pair<Wave, Wave> spike_waves = e.get_spike_waves();
		Wave spike_wave1 = spike_waves.first;
		Wave spike_wave2 = spike_waves.second;
