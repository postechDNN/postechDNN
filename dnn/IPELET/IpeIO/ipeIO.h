...
/** Get selected arcs on the primary selected page (IPE)
	If applyTrans is false, ret stores the arcs to which no transformation is applied*/
...
public:
	...
	bool Draw_arc(IpeletData* data, IpeletHelper* helper, const ipe::CurveSegment& cs);
