...
public:
	...
	CEdit m_edit_epsilon;
	CButton m_button_epsilon;
	afx_msg void OnBnClickedButtonKnn();
	afx_msg void OnBnClickedButtonEpsilon();	
	CButton m_check_cvm_input;
	CButton m_check_cvm_result;
	afx_msg void OnBnClickedCheckCvmInput();
	afx_msg void OnBnClickedCheckCvmResult();
};
